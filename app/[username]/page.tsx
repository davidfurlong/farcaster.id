      ...
      <Card className="sm:w-[400px] max-w-[400px] w-full p-0 overflow-hidden bg-white dark:bg-slate-900 text-black dark:text-white dark:border-slate-700">
          ...
          <span className="ml-2 text-sm absolute right-4 top-3">
            ...
            {/* <Dialog>
              <DialogTrigger asChild>
                <Button variant={"default"}>Visit Profile</Button>
              </DialogTrigger>
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Open Profile in App</DialogTitle>
                  <DialogDescription>
                      ...
                      >
                        ...
                        >
                          <g>
                            ...
                            <path
                              fill="#fff"
                              d="M18.7 27.54h-2.67v2.63h2.68v-2.63z"
                            ></path>
                            <path
                              fill="#fff"
                              fillRule="evenodd"
        ...
        <CardContent className="pt-6 mt-0 border-t border-dashed dark:border-slate-700">
          <CardDescription className="text-lg text-slate-800 dark:text-slate-200 mt-0 pt-0">
            <RichText text={user.profile.bio.text} />
          </CardDescription>
